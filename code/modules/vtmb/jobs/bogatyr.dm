...
/datum/outfit/job/bogatyr
	...
	backpack_contents = list(/obj/item/vamp/keys/tzimisce/manor=1, /obj/item/clothing/head/vampire/bogatyr, /obj/item/clothing/suit/vampire/bogatyr, /obj/item/passport=1, /obj/item/flashlight=1, /obj/item/card/credit=1)
