...
/atom
	...
	///Price of an item in a vending machine or retail store, overriding the base vending machine price. Define in terms of paycheck defines as opposed to raw numbers.
	var/custom_price
